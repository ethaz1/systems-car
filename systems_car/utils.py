...
def get_histogram(img, display=True, min_val=0.1, region=1):
    if region == 1:
...
def init_warping_trackbars(starting_values, wt=480, ht=240):
    cv2.namedWindow("Trackbars")
    cv2.resizeWindow("Trackbars", 360, 240)
    cv2.createTrackbar("Width Top", "Trackbars", starting_values[0], wt // 2, nothing)
    cv2.createTrackbar("Height Top", "Trackbars", starting_values[1], ht, nothing)
    cv2.createTrackbar("Width Bottom", "Trackbars", starting_values[2], wt // 2, nothing)
    cv2.createTrackbar("Height Bottom", "Trackbars", starting_values[3], ht, nothing)
